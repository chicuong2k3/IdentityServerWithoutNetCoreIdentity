...
namespace IdentityProvider.Services
{
    public class LocalUserService : ILocalUserService
    {
        ...
        public async Task AddExternalProviderToUserAsync(
           string subject,
           string provider,
           string providerIdentityKey)
        {
        ...
        public AddUserResults AddUser(User userToAdd, string password)
        {
            if (userToAdd == null)
            {
        ...
        public string GeneratePasswordResetToken(User user)
        {
            ...
            var tokenData = $"{user.Id}|{user.Email}|{DateTime.UtcNow.AddHours(1)}";
